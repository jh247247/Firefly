...
public class IdListAdapter extends RecyclerView.Adapter<IdListAdapter.ViewHolder>{
    ...
    @Override
    public IdListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                   int viewType) {
        // // create a new view
    ...
    public static class UpdateIdEvent {
	public String name; // if name matches ours, update or create id
	public String data;
    }

    public void onEvent(UpdateIdEvent e) {
	//if(m_idLookup.containsKey(e.name))
    }
}
